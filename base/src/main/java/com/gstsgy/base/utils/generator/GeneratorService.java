...
public class GeneratorService {
    ...
    public static void generateS(Class<? extends BaseTable>... classes) {
        ...
        for (Class<? extends BaseTable> clazz : classes) {
            ...
            try {
                saveToFilebyRepository(fullDir,packagePath,className);
                saveToFilebyService(fullDir,packagePath,className);
                saveToFilebyServiceImpl(fullDir,packagePath,className);
                saveToFilebyController(fullDir,packagePath,className,getClassDescription(clazz));
            }catch (Exception e) {
                e.printStackTrace();
            }
        }
    ...
    private static void saveToFilebyRepository(String fullDir, String pkg, String className) throws IOException {
        ...
        stringBuffer.append(String.format("import com.gstsgy.permission.bean.db.%s;\n",className));
        stringBuffer.append("import org.springframework.data.jpa.repository.JpaRepository;\n\n");

        stringBuffer.append(String.format("public interface %sRepository extends JpaRepository<%s, Long> {\n",className,className));
        stringBuffer.append("}");
    ...
    private static void saveToFilebyService(String fullDir, String pkg, String className) throws IOException {
    ...
    private static void saveToFilebyServiceImpl(String fullDir, String pkg, String className) throws IOException {
        ...
        stringBuffer.append(String.format("package %s;\n\n",pkg));
        stringBuffer.append(String.format("import com.gstsgy.permission.bean.db.%s;\n",className));
        stringBuffer.append(String.format("import com.gstsgy.permission.repository.%sRepository;\n",className));
        stringBuffer.append(String.format("import com.gstsgy.permission.service.%sService;\n",className));
    ...
    private static void saveToFilebyController(String fullDir, String pkg, String className,String tag) throws IOException {
